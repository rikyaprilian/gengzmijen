...
<div
    ...
    <div class="card-drag-handle me-2 edit-mode-only" title="Geser untuk mengubah urutan kartu">
        <i class="bi bi-grip-vertical text-muted fs-5"></i>
    </div>

    <div class="single-card-links links-sortable-container flex-grow-1" data-card-uuid="{{ $link->card->uuid }}">
        <div class="single-link-item d-flex align-items-center flex-grow-1" data-link data-uuid="{{ $link->uuid }}" data-card-uuid="{{ $link->card->uuid }}">
            <div class="link-drag-handle me-2 edit-mode-only" title="Geser tautan ini ke grup lain atau keluar">
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <div class="edit-mode-actions edit-mode-only d-flex align-items-center gap-1">
                    ...
                    <button type="button"
                            ...
                            data-expired-at="{{ $link->card->expired_at ? $link->card->expired_at->format('Y-m-d') : '' }}"
